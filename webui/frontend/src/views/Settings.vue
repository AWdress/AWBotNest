...
<template>
  ...
  <div v-else-if="s" class="settings">
    ...
    <div class="hint muted">提示：账号登录在「账号管理」页完成，账号列表(ACCOUNTS)会随登录自动写入。</div>
  </div>
</template>

<style scoped>
.settings { max-width: 760px; display: flex; flex-direction: column; gap: 18px; }
